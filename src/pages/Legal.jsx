      ...
      >
        ...
        <section className="space-y-6 mb-16">
          ...
          <div className="space-y-4 text-gray-300 leading-relaxed">
            ...
            <p>
              ...
              including your name, email address, and any message content. We may also collect
              basic analytics data about how you interact with our site.
            </p>
            ...
            <p>
              ...
              collaborations, and improve our services. We do not sell your personal information
              to third parties.
            </p>
        ...
        <section className="border-t border-white/10 pt-8">
          ...
          <p className="text-gray-400">
            ...
            through our <a href="/contact" className="text-cyan-400 hover:text-cyan-300">contact form</a>.
          </p>
        </section>
      </motion.div>
    </div>
