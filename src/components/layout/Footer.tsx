        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-10 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/projects" className="text-sm text-gray-500 hover:text-white transition-colors">
                  Our Projects
                </Link>
              </li>
              <li>
          ...
          {/* Research Column */}
          <div>
            <p className="text-white font-semibold text-sm mb-4">Research</p>
            <ul className="space-y-3">
              <li>
              ...
              <li>
                <Link href="/research/persist/findings" className="text-sm text-gray-500 hover:text-emerald-400 transition-colors">
                  Research Findings
                </Link>
              </li>
              <li>
