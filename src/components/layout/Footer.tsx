...
export default function Footer() {
  return (
    <footer className="obs-foot">
      <div className="in">
        <div className="obs-foot-top">
          <div className="obs-foot-brand">
            <Link href="/" className="obs-logo">
              AXION <span>DEEP</span>
            </Link>
            <p className="obs-foot-desc">
            ...
            <div className="obs-social">
              {social.map((s) => (
                <a
                  ...
                  aria-label={`Axion Deep Labs on ${s.label}`}
                >
          ...
          <div>
            <h5>Research</h5>
            <ul>
              <li><Link href="/projects/persist">PERSIST</Link></li>
              <li><Link href="/projects/grokking">Grokking</Link></li>
              <li><Link href="/projects/sdi">SDI</Link></li>
          ...
          <div>
            <h5>Portfolio</h5>
            <ul>
              <li><Link href="/projects/made4founders">Made4Founders</Link></li>
              <li><Link href="/projects/site2crm">Site2CRM</Link></li>
              <li><Link href="/projects/vesper">Vesper</Link></li>
