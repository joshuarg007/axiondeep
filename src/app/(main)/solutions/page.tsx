    ...
    <div className="snap-page relative text-gray-300">
      ...
      <section className="snap-section min-h-screen flex items-center px-6 py-16">
        <div className="max-w-6xl mx-auto">
          <div className="relative rounded-3xl overflow-hidden bg-gradient-to-br from-cyan-500/20 via-violet-500/10 to-transparent border border-cyan-500/20">
            ...
            <div className="relative grid lg:grid-cols-2 gap-8 p-8 lg:p-12">
              ...
              <div className="flex flex-col justify-center">
                <div className="flex items-center gap-3 mb-6">
                  <Image
                    src="/icons/icon-solutions-quanta.png"
                    alt="QUANTA"
                    width={48}
                    height={48}
                ...
                <p className="text-cyan-400 font-medium mb-4">
                  Build circuits, visualize qubits, master quantum concepts.
                </p>
                <p className="text-gray-400 leading-relaxed mb-6">
                  A hands-on quantum computing education platform with an interactive circuit
                  builder, real-time Bloch sphere visualization, and structured lessons from qubits
      ...
      <section className="snap-section min-h-screen flex items-center px-6 py-16">
        <div className="max-w-6xl mx-auto">
          <div className="relative rounded-3xl overflow-hidden bg-gradient-to-br from-orange-500/20 via-red-500/10 to-transparent border border-orange-500/20">
            ...
            <div className="relative grid lg:grid-cols-2 gap-8 p-8 lg:p-12">
              ...
              <div className="flex flex-col justify-center">
                <div className="flex items-center gap-3 mb-6">
                  <Image
                    src="/icons/icon-solutions-founderos.png"
                    alt="Made4Founders"
                    width={48}
                    height={48}
                    className="rounded-xl"
                  ...
                  <div>
                    ...
                    <span className="text-xs px-2 py-0.5 rounded bg-green-500/20 text-green-300 border border-green-400/30">
                      Live
                    </span>
                  </div>
                </div>
      ...
      <section className="snap-section min-h-screen flex items-center px-6 py-16">
        <div className="max-w-6xl mx-auto">
          <div className="relative rounded-3xl overflow-hidden bg-gradient-to-br from-violet-500/20 via-purple-500/10 to-transparent border border-violet-500/20">
            <div className="absolute inset-0 bg-gradient-to-r from-violet-500/10 to-transparent" />
            <div className="relative grid lg:grid-cols-2 gap-8 p-8 lg:p-12">
              <div className="flex flex-col justify-center">
                <div className="flex items-center gap-3 mb-6">
                  <Image
                    src="/icons/icon-solutions-vesper.png"
                    alt="Vesper"
                    width={48}
                    height={48}
                    className="rounded-xl"
                ...
                <p className="text-gray-400 leading-relaxed mb-6">
                  Dual AI agents work in tandem: one attacks, one analyzes. 11,697 vulnerability
                  templates covering OWASP Top 10, CVEs, and custom exploit chains. Learns from
                  every engagement to get smarter over time.
                </p>
                <div className="grid grid-cols-3 gap-4 mb-6">
                  <div className="text-center p-3 rounded-xl bg-white/5">
                ...
                <div className="flex gap-4">
                  <Link
                    ...
                    className="px-6 py-3 rounded-full bg-gradient-to-r from-violet-500 to-purple-600 font-semibold hover:opacity-90 transition"
                  >
                    Learn More
                  </Link>
                </div>
      ...
      <section className="px-6 py-16">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            {[
              {
                logo: "/icons/icon-solutions-quanta.png",
                name: "QUANTA",
                items: [
                  "Quantum algorithms (Grover's, Deutsch-Jozsa)",
                  "User accounts & progress sync",
                ],
              },
              {
                logo: "/icons/icon-solutions-site2crm.png",
                name: "Site2CRM",
                items: ["Attribution dashboard enhancements", "API v2, more CRM connectors"],
              },
              {
                logo: "/icons/icon-solutions-vesper.png",
                name: "Vesper",
                items: ["OOB refinement, attack chain viz", "Public beta, CI/CD integration"],
              },
            ].map((p) => (
              <div
                key={p.name}
      ...
      <section className="px-6 py-20">
        <div className="max-w-4xl mx-auto text-center">
          <div className="relative p-12 md:p-16 rounded-3xl bg-gradient-to-br from-white/[0.05] to-white/[0.02] border border-white/[0.08]">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Need something built?</h2>
