...
export const metadata: Metadata = {
  ...
  description:
    "Axion Deep Labs is an R&D laboratory advancing AI, quantum computing, and intelligent automation. We conduct original research and build the technologies behind next-generation software products.",
  keywords: [
  ...
  openGraph: {
    ...
    description:
      "R&D laboratory advancing AI, quantum computing, and intelligent automation. Original research powering next-generation technology.",
    images: [
      {
        url: "/og-image.png",
        width: 1200,
        height: 630,
        alt: "Axion Deep Labs — AI & Quantum Computing R&D",
      },
    ],
  },
  twitter: {
...
const jsonLd = {
  ...
  "@graph": [
    ...
    },
    {
      ...
      name: "Axion Deep Labs",
      description:
        "R&D laboratory advancing AI, quantum computing, and intelligent automation. Original research driving next-generation technology products.",
      url: "https://www.axiondeep.com",
